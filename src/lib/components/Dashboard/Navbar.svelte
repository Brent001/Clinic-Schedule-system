      ...
      <div class="relative">
        ...
        {#if showDropdown}
          ...
          >
            ...
            <!-- Navigation Links -->
            <a href="/login/dashboard" class="block px-4 py-2 text-gray-600 hover:bg-green-100 hover:text-green-800">
              Dashboard
            </a>
            <a href="/login/dashboard/logs" class="block px-4 py-2 text-gray-600 hover:bg-green-100 hover:text-green-800">
              Logs
            </a>
            <a href="/login/dashboard/register" class="block px-4 py-2 text-gray-600 hover:bg-green-100 hover:text-green-800">
              Create New Account
            </a>
